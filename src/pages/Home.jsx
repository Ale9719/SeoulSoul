...
const Home = () => {
        ...
        <div className="relative z-10">
          ...
          <div className="flex gap-4 mt-8 justify-center">
            <Link to="/store?cat=album">
                <button className="text-2xl lg:text-4xl px-8 py-3 border-2 bg-white/20 border-pink-500 text-white rounded-md font-bold hover:bg-pink-500 transition shadow-[0_0_15px_rgba(236,72,153,0.4)] cursor-pointer">
                SCOPRI GLI ALBUM
                </button>
            </Link>
  ...
  <Link to="/store?cat=merchandising">
    <button className="px-8 text-2xl lg:text-4xl py-3 border-2 bg-white/20 border-cyan-400 text-white rounded-md font-bold hover:bg-cyan-400 transition shadow-[0_0_15px_rgba(34,211,238,0.4)] cursor-pointer">
      VEDI IL MERCH
    </button>
  </Link>
          </div>
      ...
      <section className="flex flex-wrap w-full lg:w-1/4">
        <FeatureCard 
