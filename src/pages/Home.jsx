    ...
    <>
      ...
      <main className="relative min-h-[70vh] lg:h-screen flex flex-col items-center justify-center text-center px-4 py-20">
        ...
        <div className="relative z-10 w-full max-w-4xl">
          <h1 className="text-3xl sm:text-4xl lg:text-7xl font-black text-white mb-4 tracking-tighter leading-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-6 lg:mt-8 justify-center items-center">
            ...
            <Link to="/store?cat=merchandising" className="w-full sm:w-auto">
              <button className="w-full text-lg lg:text-4xl py-3 px-6 border-2 bg-white/20 border-cyan-400 text-white rounded-md font-bold hover:bg-cyan-400 transition shadow-[0_0_15px_rgba(34,211,238,0.4)] cursor-pointer">
                VEDI IL MERCH
              </button>
            </Link>
          </div>
      ...
      <section className="bg-slate-900 py-12 md:py-20 px-4 flex flex-col items-center">
        <h2 className="text-white text-2xl font-black mb-2 uppercase italic tracking-tighter text-center">
